...
def parse():
    ...
    p.add_argument('--data', type=str, default='coauthorship', help='data name (coauthorship/cocitation/hypergraph)')


    p.add_argument('--dataset', type=str, default='cora', help='dataset name (e.g.: cora/dblp for coauthorship, cora/citeseer/pubmed for cocitation, 20newsW100/ModelNet40/NTU2012/Mushroom for hypergraph)')


    p.add_argument('--node_dropping_rate', type=float, default=0.1, help='node dropping rate')


    p.add_argument('--edge_perturbation_rate', type=float, default=0.1, help='edge perturbation rate')


    p.add_argument('--lamda_ec', type=float, default=0.1, help='loss rate')
    ...
    p.add_argument('--epcc', type=float, default=0.8, help='epcc')
    p.add_argument('--epec', type=float, default=0.8, help='epec')
    return p.parse_args()
